...
public class DemoQueueConfig extends AbstractQueueConfig {
    ...
    public static final String QUEUE_NAME = "queue.spring-starter.demo";
    public static final String ROUTING_KEY = "key.spring-starter.demo";
    ...
    protected RetryHeaderConfig queueRetryConfig() {
        return buildRetryConfig(Arrays.asList(2000L, 3000L));
    }
}
